...
Invoke-Step "nacelle-core memory-limit tests" { cargo test -p nacelle-core --features exp-memory-limits --all-targets }
...
Invoke-Step "nacelle-tcp memory-limit tests" { cargo test -p nacelle-tcp --features exp-memory-limits --all-targets }
...
Invoke-Step "nacelle-http memory-limit tests" { cargo test -p nacelle-http --features exp-memory-limits --all-targets }
...
Invoke-Step "nacelle memory-limit tests" { cargo test -p nacelle --features "http,exp-memory-limits" --all-targets }
...
Invoke-Step "stress server memory-limit tests" { cargo test -p nacelle-stress-server --features exp-memory-limits --all-targets }
